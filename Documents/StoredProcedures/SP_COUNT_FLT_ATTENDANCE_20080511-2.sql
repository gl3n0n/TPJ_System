...
begin  
   ...
   for j in att_flt(dFirstDay, dEnd) loop
      ...
      begin
         ...
         values ( p_payno, p_year, p_mon, dStart, dEnd, nSeqNo, j.empl_empl_id, j.posi_code, j.title, 'REG', nSalaryR, nNumDay, j.basic_rate, nSalaryG, j.basic_rate_g, j.voya_vess_code, null, user, sysdate, 'ADD' );
      end;
