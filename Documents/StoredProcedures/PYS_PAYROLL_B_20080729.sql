...
(no_days * (select a.rate from pys_payroll_types a where a.code='OT-HOL-EXC')) no_days, 0 amt, amt OT, 0 COLA, 0 pagibig, 0 pagibig_loan, 0 sal_loan, 0 sss, 0 sss_loan, 0 philhealth, 0 whtax, 0 VALE, title, vess_code, dept_code, sal_freq, latest_vess
from   pys_payroll_dtl
