begin
   delete from pys_sss_contri_dtl where psch_payroll_no = 20080215;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080215;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080215;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080215;       
   delete from PYS_PAYROLL_DTL_LOG where payroll_no = 20080215;  
   commit;

   delete from pys_sss_contribution where period_to = to_date('20080229','YYYYMMDD');
   delete from pys_pagibig_contribution where period_to = to_date('20080229','YYYYMMDD');
   delete from pys_philhealth_contribution where period_to = to_date('20080229','YYYYMMDD');
   delete from pys_sss_contri_dtl where psch_payroll_no = 20080229;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080229;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080229;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080229;       
   delete from PYS_PAYROLL_DTL_LOG where payroll_no = 20080229;  
   commit;
...
select * from pys_payroll_dtl_log where empl_empl_id = 'B00001'
...
select * from pys_sss_contribution where period_to = to_date('20080430','YYYYMMDD')
   ...
   where  vocr.voya_voyage_date <= to_date('20080225','YYYYMMDD')
   and    vocr.dt_embarked <= to_date('20080225','YYYYMMDD')
   and    vocr.dt_disembarked is null 
   and    vocr.voya_vess_code = vess.code
   and    vocr.empl_empl_id = empl.empl_id
   and    vocr.empl_empl_id = 'C00009'
   ...
   and    vocr.dt_disembarked >= to_date('20080201','YYYYMMDD')
   and    vocr.dt_disembarked <> (to_date('20080201','YYYYMMDD')-1) -- end of month
   and    vocr.voya_vess_code = vess.code
   and    vocr.empl_empl_id = empl.empl_id
   and    vocr.empl_empl_id = 'C00009'
   and    vocr.passenger = 'N'
...
select * from pys_payroll_dtl where empl_empl_id = 'R00003'
