begin
   delete from pys_sss_contri_dtl where psch_payroll_no = 20080615;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080615;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080615;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080615;       
   commit;
...
begin
   delete from pys_sss_contribution where period_to = to_date('20080630','YYYYMMDD');
   delete from pys_pagibig_contribution where period_to = to_date('20080630','YYYYMMDD');
   delete from pys_philhealth_contribution where period_to = to_date('20080630','YYYYMMDD');

   delete from pys_sss_contri_dtl where psch_payroll_no = 20080630;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080630;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080630;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080630;       
   commit;
