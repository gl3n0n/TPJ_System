   ...
   if p_dept_code = 'FL' then
      ...
      for j in att_flt(dFirstDay, dEnd) loop
         ...
         begin
            ...
            values ( p_payno, p_year, p_mon, dStart, dEnd, nSeqNo, j.empl_empl_id, j.posi_code, j.title, vPaty, nSalaryR, nNumDay, p_basic_r, nSalaryG, decode(p_basic_g, 0, p_basic_r,p_basic_g), j.voya_vess_code, 'FL', user, sysdate, 'ADD', vAdjFlag, 'MONTHLY' );
