create or replace procedure sp_payroll_summary (
   ...
   nSILP_a      Number(8,2);  
   nSILP_b      Number(8,2);  
   n13th_amt_a  Number(8,2);  
   n13th_amt_b  Number(8,2);
   dPeriodFr    Date;
   dPeriodTo    Date;
begin
   -- clear summary 
         ...
         loop 
            ...
            loop
               ...
               insert into pys_13th_month 
                      (empl_id, payroll_no, period_to, basic_rate, basic_rate_a, amt, amt_a, cola_rate, cola_amt, no_days, dept_code, vess_code, title ) 
               values 
                      (i.empl_id, p_payroll_no, dEnd, k.basic_rate, k.basic_rate_g, m.amount,  nAMt_a, m.cola_rate, m.cola_amt, m.no_days, i.dept_code, k.l_vess_code, nvl(k.l_title, k.title) );                
            end loop;
            ...
            for n in (select pay.basic_rate basic_rate_b, 
                             ...
                             decode(greatest(pay.no_days,15),15,.5,1) nMon
