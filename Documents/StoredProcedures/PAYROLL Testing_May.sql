begin
   delete from pys_sss_contri_dtl where psch_payroll_no = 20080515;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080515;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080515;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080515;       
   delete from PYS_PAYROLL_DTL_LOG where payroll_no = 20080515;
   commit;
...
begin
   delete from pys_sss_contribution where period_to >= to_date('20080531','YYYYMMDD');
   delete from pys_pagibig_contribution where period_to >= to_date('20080531','YYYYMMDD');
   delete from pys_philhealth_contribution where period_to >= to_date('20080531','YYYYMMDD');

   delete from pys_sss_contri_dtl where psch_payroll_no >= 20080531;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no >= 20080531;
   delete from pys_health_contri_dtl where phch_payroll_no >= 20080531;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no >= 20080531;       
   delete from PYS_PAYROLL_DTL_LOG where payroll_no >= 20080531;
   commit;
...
select * from pys_sss_contribution where period_to = to_date('20080430','YYYYMMDD')
   ...
   where  vocr.voya_voyage_date <= to_date('20080515','YYYYMMDD')
   and    vocr.dt_embarked <= to_date('20080515','YYYYMMDD')
   ...
   and    vocr.dt_disembarked >= to_date('20080426','YYYYMMDD')
