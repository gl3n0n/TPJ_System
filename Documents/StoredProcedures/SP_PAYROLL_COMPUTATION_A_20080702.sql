...
begin
      ...
      if i.taty_code is not null then         -- START: Tax Type checking (no Deduction loop)
         ...
         if i.empl_type = 'OFC' then
            ...
            sp_count_flt_attendance ( i.empl_empl_id, p_payno, p_year, p_mon, p_date_fr, p_date_to,
                                      nSunday_RF, nHoliday_RF, nHolSun_RF,
                                      nSeqNo, vSalFreq, nNumHrs, nSalaryG, nSuPay, nHoPay, nHSPay, nAllowances, vLatestVess, vLatestTitle, nSeqNo);
         end if;
            ...
            if (nvl(nSalaryG,0) > 0) then
               ...
               begin
                  --if nSalaryG >= 1000 then   -- added by thess 04042008 to filter salaries less than 1000
                     ...
                     values ( p_payno, p_year, p_mon, p_date_fr, p_date_to, nSeqNo, i.empl_empl_id, i.posi_code, 'SSS', nSSS, nSalaryG, i.dept_code, user, sysdate, 'LESS', vSalFreq, vLatestVess, vLatestTitle );
               ...
               begin
                  ...
                  insert into pys_payroll_dtl
                         ( pahd_payroll_no, pahd_year, pahd_mo, period_fr, period_to, seq_no, empl_empl_id, posi_code, paty_code, amt, basic_rate, dept_code, created_by, dt_created, pay_flag, sal_freq, latest_vess, title )
                  values ( p_payno, p_year, p_mon, p_date_fr, p_date_to, nSeqNo, i.empl_empl_id, i.posi_code, 'PAGIBIG', nPagibig, nSalaryG, i.dept_code, user, sysdate, 'LESS', vSalFreq, vLatestVess, vLatestTitle );
               ...
               begin
                  ...
                  insert into pys_payroll_dtl
                         ( pahd_payroll_no, pahd_year, pahd_mo, period_fr, period_to, seq_no, empl_empl_id, posi_code, paty_code, amt, basic_rate, dept_code, created_by, dt_created, pay_flag, sal_Freq, latest_vess, title )
                  values ( p_payno, p_year, p_mon, p_date_fr, p_date_to, nSeqNo, i.empl_empl_id, i.posi_code, 'PHILHEALTH', nPhHealth, nSalaryG, i.dept_code, user, sysdate, 'LESS', vSalFreq, vLatestVess, vLatestTitle );
               ...
               begin
                  ...
                  if nTaxable >= 0 then  -- added by thess 04042008 to validate net taxable salary
                     ...
                     insert into pys_payroll_dtl
                            ( pahd_payroll_no, pahd_year, pahd_mo, period_fr, period_to, seq_no, empl_empl_id, posi_code, paty_code, amt, basic_rate, dept_code, created_by, dt_created, pay_flag, sal_freq, latest_vess, title )
                     values ( p_payno, p_year, p_mon, p_date_fr, p_date_to, nSeqNo, i.empl_empl_id, i.posi_code, 'WHTAX', nWhTax, nTaxable, i.dept_code, user, sysdate, 'LESS', vSalFreq, vLatestVess, vLatestTitle );
                  end if;
               end;
               ...
               for z in dedu (i.empl_empl_id) loop
                  ...
                  values ( p_payno, p_year, p_mon, p_date_fr, p_date_to, nSeqNo, i.empl_empl_id, i.posi_code, z.dety_code, z.seq_no, z.amt, 0, i.dept_code, user, sysdate, 'LESS', vSalFreq, vLatestVess, vLatestTitle );
   ...
   -- generate payroll A details
   delete from pys_payroll_a_dtl where pahd_payroll_no = p_payno;

   insert into pys_payroll_a_dtl (
          pahd_payroll_no, period_fr, period_to, empl_empl_id, basic_rate, no_days,
          amt, pagibig, pagibig_loan, sal_loan, sss, sss_loan, philhealth, whtax,
          title, vess_code, dept_code, ot, cola, sal_freq, latest_vess
         )
   select pahd_payroll_no, period_fr, period_to, empl_empl_id, basic_rate, no_days,
           amt, pagibig, pagibig_loan, sal_loan, sss, sss_loan, philhealth, whtax,
           title, vess_code, dept_code, ot, cola, sal_freq, latest_vess
   from   pys_payroll_a
   where  pahd_payroll_no = p_payno;

   update pys_payroll_a_dtl
   set    whtax = sf_get_whtax_a(empl_empl_id, (no_days*basic_rate)-(sss+pagibig+philhealth))
   where  pahd_payroll_no = p_payno
   and    no_days > 0 and basic_rate > 0;
