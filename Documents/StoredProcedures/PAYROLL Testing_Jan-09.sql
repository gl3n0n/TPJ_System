begin
   sp_payroll_computation_a (20141231, '2014','12',to_date('20141216','YYYYMMDD'),to_date('20141231','YYYYMMDD')); 
end;

begin
   sp_payroll_computation_a (20090228, '2009','02',to_date('20090216','YYYYMMDD'),to_date('20090228','YYYYMMDD')); 
   commit;
end;

begin
   SP_PAYROLL_SUMMARY_EMPL(20141231, 'P00014');
end;
