alter table acc_ap_summary_sundry add acco_code varchar2(12);
...
begin
  ...
  loop
    ...
    if a.acco_code = v_ewt_code then
       ...
       values (a.ap_no, sf_acc_get_account_name(a.acco_code), a.credit_php, a.debit_php, user, a.acco_code);
    end if;
