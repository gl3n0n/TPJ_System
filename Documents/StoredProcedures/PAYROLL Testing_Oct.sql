begin
   sp_payroll_computation_a (20081015, '2008','10',to_date('20081001','YYYYMMDD'),to_date('20081015','YYYYMMDD')); 
   commit;
end;

begin
   sp_payroll_computation_a (20081031, '2008','10',to_date('20081016','YYYYMMDD'),to_date('20081031','YYYYMMDD')); 
   commit;
end;
...
and    pahd_payroll_no in (20081015,20080931)
