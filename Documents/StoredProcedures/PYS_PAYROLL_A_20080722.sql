...
from
(
select pahd_payroll_no, period_fr, period_to, empl_empl_id, decode(sal_freq,'MONTHLY',decode(dept_code,'FL',basic_rate,basic_rate_g),basic_rate_g) basic_rate, no_days, amt_g amt, 0 pagibig, 0 pagibig_loan, 0 sal_loan, 0 sss, 0 sss_loan, 0 philhealth, 0 whtax, title, vess_code, dept_code, 0 OT, 0 COLA, sal_freq, latest_vess
