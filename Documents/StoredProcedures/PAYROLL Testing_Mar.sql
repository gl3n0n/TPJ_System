begin
   delete from pys_sss_contri_dtl where psch_payroll_no = 20080315;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080315;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080315;
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080315;
   delete from PYS_PAYROLL_DTL_LOG where payroll_no = 20080315;
   commit;
...
begin
   delete from pys_sss_contribution where period_to = to_date('20080331','YYYYMMDD');
   delete from pys_pagibig_contribution where period_to = to_date('20080331','YYYYMMDD');
   delete from pys_philhealth_contribution where period_to = to_date('20080331','YYYYMMDD');

   delete from pys_sss_contri_dtl where psch_payroll_no = 20080331;
   delete from pys_pagibig_contri_dtl where ppch_payroll_no = 20080331;
   delete from pys_health_contri_dtl where phch_payroll_no = 20080331;                
   delete from PYS_PAYROLL_DTL where pahd_payroll_no = 20080331;       
   delete from PYS_PAYROLL_DTL_LOG where payroll_no = 20080331;
   commit;
...
select payroll_no from pys_payroll_hdr where  period_fr between to_date('20080301', 'YYYYMMDD') and to_date('20080331', 'YYYYMMDD');
