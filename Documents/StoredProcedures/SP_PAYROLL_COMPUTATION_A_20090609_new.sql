...
(
   ...
   dPrevStart   DATE;
   nPrevSal     NUMBER(12,4);
   nPrevAllo    NUMBER(12,4);
   nPrevDays    NUMBER(8,3);

   nNumHrs      NUMBER(6,3);
   nAllowances  NUMBER(12,4);
   nDeduction   NUMBER(12,4) := 0;
   nVale        NUMBER(12,4) := 0;
   vLatestVess  VARCHAR2(32);
   vLatestTitle VARCHAR2(32);
   nSalaryG_D   NUMBER(12,4);
   nSalaryG_B   NUMBER(12,4);
   nSalaryG_R   NUMBER(12,4);
   dPeriodTOG   DATE;
   bFixMonthly  BOOLEAN;
   nAdjCount    NUMBER;
   nMaxPayNo    NUMBER;
